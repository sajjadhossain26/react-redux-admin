...
const Header = () => {
    ...
    const {isOpen: isNotification, toogleMenu:notificationMenu, dropDownRef: notificationRef} = useDropdownPopupControl()
  return (
    <>
      	{/* <!-- Header --> */}
          <div className="header">
            ...
            <ul className="nav user-menu">
                ...
                <li className="nav-item dropdown noti-dropdown" ref={notificationRef}>
                  ...
                  {
                    isNotification &&   <div className="dropdown-menu notifications d-block" style={{transform: "translate(-309px, 0px)"}}>
                            ...
                            <ul className="notification-list">
                                    ...
                                    <a href="#">
                                        <div className="media">
                                            <span className="avatar avatar-sm">
                                                <img className="avatar-img rounded-circle" alt="User Image" src={doctor1}/>
                                            </span>
                                ...
                                <li className="notification-message">
                                    <a href="#">
                                        <div className="media">
                                            <span className="avatar avatar-sm">
                                                <img className="avatar-img rounded-circle" alt="User Image" src={patient1}/>
                                            </span>
                                            <div className="media-body">
                ...
                <li className="nav-item dropdown has-arrow" ref={dropDownRef}>
                  ...
                  {
                    isOpen &&   <div className="dropdown-menu d-block" style={{transform: "translate(-131px, 0px)"}}>
